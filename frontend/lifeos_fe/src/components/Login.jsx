        ...
        <div className="min-h-screen w-full flex items-center justify-center bg-slate-50 dark:bg-slate-950 px-4">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="mt-2 text-slate-500 dark:text-slate-400 text-sm">Sign in to your everyday hub</p>
                </div>
                ...
                <p className="mt-6 text-center text-sm text-slate-500 dark:text-slate-400">
                    ...
                    <Link to="/register" className="font-semibold text-violet-500 hover:text-violet-600 transition">
                        Create one
                    </Link>
                </p>
            </div>
